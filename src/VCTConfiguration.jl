...
function loadRulesets(M::AbstractMonad)
    ...
    path_to_rulesets_xml = joinpath(path_to_rulesets_collections_folder, "rulesets_collections_variations",
                                    "rulesets_variation_$(M.variation_ids.rulesets).xml")
...
function loadICCells(M::AbstractMonad)
    ...
    path_to_ic_cells_xml = joinpath(path_to_ic_cells_folder, "ic_cell_variations",
                                    "ic_cell_variation_$(M.variation_ids.ic_cell).xml")
