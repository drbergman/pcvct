...
function Simulation(base_config_id::Int, rulesets_collection_id::Int, ic_cell_id::Int, ic_substrate_id::Int, ic_ecm_id::Int, custom_code_id::Int)
    ...
    return Simulation(folder_ids, variation_id, rulesets_variation_id)
end
...
function Simulation(base_config_id::Int, rulesets_collection_id::Int, ic_substrate_id::Int, ic_ecm_id::Int, custom_code_id::Int, variation_id::Int, rulesets_variation_id::Int)
    folder_ids = AbstractSamplingIDs(base_config_id, rulesets_collection_id, ic_cell_id, ic_substrate_id, ic_ecm_id, custom_code_id)
    folder_names  = AbstractSamplingFolders(folder_ids)
...
function Monad(min_length::Int, folder_ids::AbstractSamplingIDs)
    folder_names = AbstractSamplingFolders(folder_ids)
    return Monad(min_length, folder_ids, folder_names)
end

function Monad(min_length::Int, folder_ids::AbstractSamplingIDs, folder_names::AbstractSamplingFolders)
    variation_id = 0
...
function Monad(sampling::Sampling, variation_id::Int, rulesets_variation_id::Int)
    # I'm a little concerned that this is not checking that the variation ids are those used by the sampling...
    return Monad(sampling.monad_min_length, sampling.folder_ids, sampling.folder_names, variation_id, rulesets_variation_id)
end

function Sampling(monad_min_length::Int, base_config_id::Int, rulesets_collection_id::Int, ic_substrate_id::Int, ic_ecm_id::Int, custom_code_id::Int, variation_ids::Array{Int}, rulesets_variation_ids::Array{Int})
    folder_ids = AbstractSamplingIDs(base_config_id, rulesets_collection_id, ic_cell_id, ic_substrate_id, ic_ecm_id, custom_code_id)
...
function Sampling(monad_min_length::Int, folder_ids::AbstractSamplingIDs, variation_ids::Array{Int}, rulesets_variation_ids::Array{Int})
    ...
    id = getSamplingId(monad_ids)
    return Sampling(id, monad_min_length, monad_ids, folder_ids, folder_names, variation_ids, rulesets_variation_ids)
end

function Sampling(monad_min_length::Int, base_config_folder::String, rulesets_collection_folder::String, ic_cell_folder::String, ic_substrate_folder::String, ic_ecm_folder::String, custom_code_folder::String, variation_ids::Array{Int}, rulesets_variation_ids::Array{Int})
...
function Trial(monad_min_length::Int, base_config_ids::Vector{Int}, rulesets_collection_ids::Vector{Int}, ic_cell_ids::Vector{Int}, ic_substrate_ids::Vector{Int}, ic_ecm_ids::Vector{Int}, custom_code_ids::Vector{Int}, variation_ids::Vector{Vector{Int}}, rulesets_variation_ids::Vector{Vector{Int}})
