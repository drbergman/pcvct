...
function Monad(sampling::Sampling, index::Int)
    return Monad(sampling.monad_min_length, sampling.base_config_id, sampling.rulesets_collection_id, sampling.ic_id, sampling.custom_code_id, sampling.base_config_folder, sampling.rulesets_collection_folder, sampling.ic_folder, sampling.custom_code_folder, sampling.variation_ids[index], sampling.rulesets_variation_ids[index])
end
...
function Sampling(monad_min_length::Int, base_config_folder::String, rulesets_collection_folder::String, ic_folder::String, custom_code_folder::String, variation_ids::Array{Int}, rulesets_variation_ids::Array{Int})
    ...
    ic_id = retrieveID("ics", ic_folder)
...
function Trial(monad_min_length::Int, base_config_ids::Vector{Int}, rulesets_collection_ids::Vector{Int}, ic_ids::Vector{Int}, custom_code_ids::Vector{Int}, base_config_folders::Vector{String}, rulesets_collection_folders::Vector{String}, ic_folders::Vector{String}, custom_code_folders::Vector{String}, variation_ids::Vector{Vector{Int}}, rulesets_variation_ids::Vector{Vector{Int}})
    sampling_ids = createSamplingIDs(monad_min_length, base_config_ids, rulesets_collection_ids, ic_ids, custom_code_ids, base_config_folders, rulesets_collection_folders, ic_folders, custom_code_folders, variation_ids, rulesets_variation_ids)
...
function createSamplingIDs(monad_min_length::Int, base_config_ids::Vector{Int}, rulesets_collection_ids::Vector{Int}, ic_ids::Vector{Int}, custom_code_ids::Vector{Int}, base_config_folders::Vector{String}, rulesets_collection_folders::Vector{String}, ic_folders::Vector{String}, custom_code_folders::Vector{String}, variation_ids::Vector{Vector{Int}}, rulesets_variation_ids::Vector{Vector{Int}})
...
function Trial(samplings::Vector{Sampling})
    ...
    ic_ids = [sampling.ic_id for sampling in samplings]
    ...
    ic_folders = [sampling.ic_folder for sampling in samplings]
    ...
    return Trial(monad_min_length, sampling_ids, base_config_ids, rulesets_collection_ids, ic_ids, custom_code_ids, base_config_folders, rulesets_collection_folders, ic_folders, custom_code_folders, variation_ids, rulesets_variation_ids)
end

function Trial(monad_min_length::Int, sampling_ids::Vector{Int}, base_config_ids::Vector{Int}, rulesets_collection_ids::Vector{Int}, ic_ids::Vector{Int}, custom_code_ids::Vector{Int}, base_config_folders::Vector{String}, rulesets_collection_folders::Vector{String}, ic_folders::Vector{String}, custom_code_folders::Vector{String}, variation_ids::Vector{Vector{Int}}, rulesets_variation_ids::Vector{Vector{Int}})
    id = getTrialId(sampling_ids)
    return Trial(id, monad_min_length, sampling_ids, base_config_ids, rulesets_collection_ids, ic_ids, custom_code_ids, base_config_folders, rulesets_collection_folders, ic_folders, custom_code_folders, variation_ids, rulesets_variation_ids)
end