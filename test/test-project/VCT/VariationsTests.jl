...
distributed_variation = UniformDistributedVariation(xml_path, 0.0, 1.0)
@test_throws ErrorException pcvct._values(distributed_variation)
...
config_variation_ids, rulesets_variation_ids, ic_cell_variation_ids =
    addVariations(LHSVariation(4), discrete_variations, config_folder;
                  rulesets_collection_folder=rulesets_collection_folder,
                  ic_cell_folder=ic_cell_folder)
...
config_variation_ids, rulesets_variation_ids, ic_cell_variation_ids =
    addVariations(pcvct.SobolVariation(5), discrete_variations, config_folder;
                  rulesets_collection_folder=rulesets_collection_folder,
                  ic_cell_folder=ic_cell_folder)
...
push!(discrete_variations, DiscreteVariation(xml_path, [1.0, 2.0]))
config_variation_ids, rulesets_variation_ids, ic_cell_variation_ids =
    addVariations(pcvct.SobolVariation(5; skip_start=false), discrete_variations,
                  config_folder;
                  rulesets_collection_folder=rulesets_collection_folder,
                  ic_cell_folder=ic_cell_folder)
...
push!(discrete_variations, DiscreteVariation(xml_path, vals))
config_variation_ids, rulesets_variation_ids, ic_cell_variation_ids =
    addVariations(pcvct.SobolVariation(5; skip_start=4, include_one=true),
                  discrete_variations, config_folder; 
                  rulesets_collection_folder=rulesets_collection_folder,
                  ic_cell_folder=ic_cell_folder)

# Test edge cases of addRBD
config_variation_ids, rulesets_variation_ids, ic_cell_variation_ids =
    addVariations(pcvct.RBDVariation(1), discrete_variations, config_folder;
                  rulesets_collection_folder=rulesets_collection_folder,
                  ic_cell_folder=ic_cell_folder)
...
push!(discrete_variations, DiscreteVariation(xml_path, vals))
config_variation_ids, rulesets_variation_ids, ic_cell_variation_ids =
    addVariations(pcvct.RBDVariation(2), discrete_variations, config_folder;
                  rulesets_collection_folder=rulesets_collection_folder,
                  ic_cell_folder=ic_cell_folder)
...
push!(discrete_variations, DiscreteVariation(xml_path, [1.0, 2.0]))
config_variation_ids, rulesets_variation_ids, ic_cell_variation_ids =
    addVariations(pcvct.RBDVariation(3), discrete_variations, config_folder;
                  rulesets_collection_folder=rulesets_collection_folder,
                  ic_cell_folder=ic_cell_folder)

config_variation_ids, rulesets_variation_ids, ic_cell_variation_ids =
    addVariations(pcvct.RBDVariation(3; use_sobol=false), discrete_variations,
                  config_folder;
                  rulesets_collection_folder=rulesets_collection_folder,
                  ic_cell_folder=ic_cell_folder)
